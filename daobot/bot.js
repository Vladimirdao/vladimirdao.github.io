...
'\n' +
'\n' +
'Еще у нас есть группа, где публикуются очень вдохновляющие стихи и цитаты из наших книг, она отлично подойдет для мотивации. Чтобы получить ссылку на эту группу нажимай кнопку "Мотивация"' +
'\n' +
'\n' +
