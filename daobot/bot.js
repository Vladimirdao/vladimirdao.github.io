...
'\n' +
'\n' +
'Ну а если ты уже рвешься в бой и горишь желанием сразу начать практиковать, то нажимай кнопку "Совместные практики". Тебе в ответ придет ссылка на группу, в которой можно попрактиковать вместе с нашими Воинами или записаться на индивидуальные занятия.'
...
const mainKeyboard = Markup.keyboard([
  ...
  [
    Markup.button('Мотивация', 'primary')
  ],
  [
...
bot.command('С чего начать', (ctx) => {
  ctx.reply('Отличный выбор!' +
  '\n' +
  '"Новое Начало" это методичка, в которой описана наша философия и фундаментальные практики. Усердно занимаясь по ней, ты станешь сильным Воином и подготовишься к будующим великим свершениям и прорывам!',
  [
...
// Наши книги
bot.command('Наши книги', (ctx) => {
  ctx.reply('Наши книги',
  null,
  Markup.keyboard([
    [
      Markup.button('Книга 1', 'primary'),
      Markup.button('Книга 2', 'primary'),
      Markup.button('Книга 3', 'primary')
    ],
    [
      Markup.button('Книга 4', 'primary'),
      Markup.button('Книга 5', 'primary'),
      Markup.button('Книга 6', 'primary')
    ],
    [
      Markup.button('Книга 7', 'primary'),
      Markup.button('Книга 8.1', 'primary'),
      Markup.button('Книга 8.2', 'primary')
    ],
    [
      Markup.button('Книга 9', 'primary'),
      Markup.button('Книга 10', 'primary'),
      Markup.button('Книга 11', 'primary')
    ],
    [
      Markup.button('Меня интересует еще кое-что', 'primary')
    ]
...
// Мотивация
bot.command('Мотивация', (ctx) => {
  ctx.reply('Похож за Духом - бесконечен,' +
  '\n' +
  'даже сами боги не знают конца.' +
  '\n' +
  'Только твое стремление' +
  '\n' +
  'определяет величину Пути.' +
  '\n' +
  'А Дух будет вести и вести,' +
  '\n' +
  ...
  'Ссылка на руппу:' +
  '\n' +
  '@nagval_dao - Нагваль Дао Цитаты',
  'photo-184236909_456239031',
  endDialog
  )
})

// Совместные практики
bot.command('Совместные практики', (ctx) => {
  ctx.reply('Очень рад тебя видеть в этом разделе!' +
  '\n' +
  'То, что ты здесь может означать только одно, что у тебя серьезные намерения и решимость действовать, это похвально.' +
  '\n' +
  '\n' +
  'Ссылка на группу с практиками' +
  '\n' +
  '@onlinenagvaldao - Нагваль Дао. Практики' +
  '\n' +
  '\n' +
  'Если у тебя есть вопросы, то ты можешь их смело задать нашим воинам:' +
  '\n' +
  '@vihod_v_kosmos - Юлия Макаренко' +
  '\n' +
  '@mechosoznania - Василий Мечосознания' +
  '\n' +
  '@svet_dao - Aliya Gandi',
  null,
  endDialog
  )
})
