...
'\n' +
'\n' +
'Так же здесь представленны наши книги, они написаны в виде отдельных статей, в них описан настоящий духовный опыт и прохождения нашего учителя и Воинов, сновидения, видения, полеты в духовных телах, контакты, стихи' +
'\n' +
'\n' +
'Еще у нас есть группа, где публикуются разные стихи и цитаты из наших книг, она отлично подойдет для самомотивации и напоминания себе о том, что ты воин, и что каждую секнду в тебе идет сражение' +
'\n' +
'\n' +
'Ну а если ты рвешься в бой, то нажимай кнопку "Совместные практики". Тебе в ответ придет ссылка на группу, в которой проводяться воместные практики'
